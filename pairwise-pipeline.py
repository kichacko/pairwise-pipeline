...
if os.path.getsize('./' + str(fourtarg) + '/NucDIFF/results/NucDIFF_ref_snps.gff') == 0:
    print ('NucDIFF found 0 SNPS')
else:
    ...
    if os.path.getsize('./' + str(fourtarg) + '/Annovar/Annovar_Input.txt.exonic_variant_function') == 0:
        print ('\n' + 'There were not exonic SNP variants found by Annovar. Skipping to synonymous variants...' + '\n')
    
    else:
        print ('\n' + 'Creating exonic output files...' + '\n')
...
# Structural Variants
if os.path.getsize('./' + str(fourtarg) + '/NucDIFF/results/NucDIFF_ref_struct.gff') == 0:
    print ('NucDIFF found 0 SVs')
else:
    ...
    if os.path.getsize('./' + str(fourtarg) + '/Annovar/Annovar_SV_Input.txt.exonic_variant_function') == 0:
        print ('\n' + 'There were not exonic SVs found by Annovar. Skipping to synonymous SVs...' + '\n')
    else:
        print ('\n' + 'Creating exonic SV output files...' + '\n')
